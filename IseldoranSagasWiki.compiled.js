/* AUTO-GENERATED from IseldoranSagasWiki.jsx by scripts/build-wiki.mjs. Do not edit directly — edit the .jsx and run `npm run build:wiki`. */
const {
  useState,
  useEffect,
  useRef
...
const SERIES = {
  iseldoran: {
    label: "The Iseldoran Sagas",
    color: "var(--gold)"
  },
  martyrs: {
    label: "Code of Martyrs",
    color: "#a070d0"
  },
  generalisima: {
    label: "La Generalísima",
    color: "var(--gold)"
  }
};
const BOOKS = [{
  ...
  sub: "Compiled from the Imperial Archives · Volume I",
  words: "45,707",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 2,
  title: "Black Death: Kaelen I",
  sub: "A Novel of Empire, War, and the Edge of Known Space",
  words: "88,690",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  sub: "The War That Made the Twin Thrones",
  words: "80,437",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 4,
  title: "The Chronicle of Aurelian",
  sub: "Being the Complete Account of the Reign of Aurelian Pierre von Care",
  words: "20,507",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 5,
  title: "The Soldier Emperors",
  sub: "Cassander I · Lucius Luceron II · The Schism of the Two Flames",
  words: "79,247",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 6,
  title: "Lucius Luceron III",
  sub: "The Philosopher Emperor",
  words: "66,569",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 8,
  title: "The Bastard God: Augustus Rex",
  sub: "God-Emperor of Mankind · Beyond the Rim",
  words: "67,537",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 9,
  title: "Niccolò: Thunderborn",
  sub: "The Storm-Child of House Hapsburgi",
  words: "27,738",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 10,
  title: "The Strangling of the Belt",
  sub: "The Merchant War: Prelude",
  words: "69,964",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 12,
  title: "The Quiet King",
  sub: "Germionus de Maldor · The Immune System",
  words: "70,091",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 13,
  title: "Haradakus",
  sub: "The Eastern Sectors · A Popular Fiction of Historical Record",
  words: "55,477",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 14,
  title: "Father's Gift",
  sub: "The Runeus Question · Events Following the Wedding War",
  words: "80,126",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 15,
  title: "Aurelia: The Goddess Empress",
  sub: "Book of the Daughter · Second Edition",
  words: "69,513",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 16,
  title: "Mettenik I: Restorer of the Dragon Throne",
  sub: "A Chronicle of the Twenty-Seven",
  words: "137,720",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 17,
  title: "The First Khan",
  sub: "A Chronicle of the Twenty-Seven · 144,571 words",
  words: "144,571",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 18,
  title: "The Iberian Wars: Book One",
  sub: "The Crown and the Crescent · Exile: The Hidden Prince",
  words: "18,630",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 19,
  title: "Leraq: An Autobiography",
  sub: "In His Own Words · 5,157 Words",
  words: "5,157",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 20,
  title: "Cassander's Revenge",
  sub: "The Vengeance Era · The Purge at Remisión 9",
  words: "31,362",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 21,
  title: "Notes on Cassander's Final Years",
  sub: "Supplemental Scenes and Testimony · Companion to The Soldier Emperors",
  words: "8,489",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 22,
  title: "Lucius Luceron II",
  sub: "The Philosopher Emperor Who Went to War",
  words: "36,840",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 23,
  title: "No Gods No Masters: Appendices & Notes",
  sub: "Vol. I Companion · The Codex of Restoration",
  words: "3,276",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 24,
  title: "The Twin Thrones",
  sub: "Ysinde and Isolde · The Dawn Empresses",
  words: "87,082",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 25,
  title: "Khutun's Revenge",
  sub: "The Administrative Annihilation · The Kasparian Belt",
  words: "64,737",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 26,
  title: "Dominus and Olympia",
  sub: "The Divine Pair · Narrated by the Granddaughter",
  words: "33,165",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 27,
  title: "The Supreme Rule",
  sub: "Augustus Dominus Rex · Parts I–VII",
  words: "35,591",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 28,
  title: "Augustus Dominus Rex: The Final God",
  sub: "The Closing Era",
  words: "32,817",
  series: "iseldoran",
  k: "#",
  ...
  id: 29,
  title: "VSGE Imperial Chronicles Vol. II",
  sub: "The Asha Kers I Era · The Purge",
  words: "14,263",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 30,
  title: "VSGE Imperial Chronicles Vol. III",
  sub: "The Commission · What Asha Builds Next",
  words: "20,180",
  series: "iseldoran",
  k: "#",
  p: "#",
  ...
  id: 31,
  title: "La Generalísima",
  sub: "The Seven Days, The Fall of the Meraud Free Republic",
  words: "TBA",
  series: "generalisima",
  k: "#",
  p: "#",
  cover: IMG.generalisima3,
  desc: "Selene Jaza. First Generalísima of the Black Death. The Seven Days. Twenty-five years of praise. 'The Emperor builds the empire. The Generalísima defends its existence. The Archivist ensures its memory.' — Kairoh Pierre von Care",
  featured: true
}, {
  id: 32,
  title: "La Generalísima: Appendices & Notes",
  sub: "Authorised Publisher's Edition",
  words: "TBA",
  series: "generalisima",
  k: "#",
  p: "#",
  cover: IMG.generalisima2,
  desc: "The sealed archive. The Seven Days canon notes. The character registry. The Muskus timeline. The al-Saud Compact. Loyalty is reality. Reality is law. Law is eternal."
}, {
  id: 33,
  title: "Five Swords, One Throne",
  sub: "Part One · Brotherhood, Blood and the Fall of the Pharaoh",
  words: "TBA",
  series: "iseldoran",
  k: "#",
  p: "#",
  cover: IMG.fiveSwords1,
  desc: "Five men. Five swords. Raised in blood. Bound by brotherhood. Forged by war. From the training pits of Solera to the fall of a Pharaoh, their legend is written in blood, and history will never know the truth.",
  featured: true
}, {
  id: 34,
  title: "The Sapphire Eye",
  sub: "Code of Martyrs · Book I",
  words: "~50K",
  series: "martyrs",
  k: "#",
  p: "#",
  desc: "The Dragon Throne of Maldorus. Shapur the Eternal. The brothers Ashim the Lion and Ishak the Fox. The rot that hides in the perfume. Nashim XII in the Baths of Kasparia."
}, {
  id: 35,
  title: "The Withered King",
  sub: "Code of Martyrs · Book II",
  words: "~60K",
  series: "martyrs",
  k: "#",
  p: "#",
  desc: "Ishak — The Withered King. The secret hunger of the empire. The continuation of the brothers' war."
}, {
  id: 36,
  title: "The Winnowing of Maldorus",
  sub: "Code of Martyrs · Book III",
  words: "~65K",
  series: "martyrs",
  k: "#",
  p: "#",
  desc: "The Engine of Bone. The Hestian Arks — welded corpses. Hulls of dead destroyers stitched together with erratic welds. The galaxy consuming its own fleets."
}, {
  id: 37,
  title: "The Chronicles of the Glass Eye",
  sub: "Code of Martyrs · Book IV",
  words: "~70K",
  series: "martyrs",
  k: "#",
  p: "#",
  desc: "Kaisar Vane — The Iron God. Gamelon the Jester. The Victory of Peace. The soul pulled from the Lattice. The most terrible victory of all."
}, {
  id: 38,
  title: "Code of Martyrs: Complete Saga",
  sub: "Books I–IV",
  words: "686 pages",
  series: "martyrs",
  k: "#",
  p: "#",
  desc: "The complete Code of Martyrs saga in a single volume — all four books from the Dragon Throne of Maldorus to the final victory of the Iron God."
}];
const PORTRAITS_20 = [{
  n: "Kerron Pierre von Care",
  e: "The Dragon Emperor",
  era: "Founding Era"
}, {
  n: "Isabelle of Mallorca",
  e: "The Moving Empress",
  era: "Founding Era"
}, {
  n: "Hamish Pierre von Care",
  e: "The Shielded King",
  era: "Founding Era"
}, {
  n: "Cassian I Pierre von Care",
  e: "The First God-King",
  era: "Founding Era"
}, {
  n: "Cassiel",
  e: "The Wandering Emperor",
  era: "Cassiel Withdrawal Era"
}, {
  n: "Lucius Luceron I",
  e: "The Flame Bearer",
  era: "First Luceron Restoration"
}, {
  n: "Kaelen Rainmaker",
  e: "The Living Weapon",
  era: "First Luceron Restoration"
}, {
  n: "Isolde Pierre von Care",
  e: "The Twin Throne",
  era: "First Luceron Restoration"
}, {
  n: "Ysinde Pierre von Care",
  e: "The Dawn Empress",
  era: "First Luceron Restoration"
}, {
  n: "Aurelian",
  ...
  n: "Lucius Luceron II",
  e: "The Restorer",
  era: "Second Luceron Restoration"
}, {
  n: "Empress Amira",
  e: "The Bastard Goddess",
  era: "Goddesses and Dominion"
}, {
  n: "Augustus Rex",
  e: "The Bastard God",
  era: "Goddesses and Dominion"
  ...
  n: "Niccolò Kerron von Hapsburgi",
  e: "The Thunderborn",
  era: "Goddesses and Dominion"
}, {
  n: "Khutun Ghega Khan",
  ...
  n: "Khutulun",
  e: "The Empress-Warrior",
  era: "Khanate Era"
}, {
  n: "Khuvius",
  e: "Crown Prince of War — Star Wolf Prince",
  era: "Star Wolf Era"
}, {
  n: "Asha Kers I",
  e: "La Diosa · Queen of the Vah'Sumir",
  era: "Goddesses and Dominion"
}];
const PORTRAITS_14 = [{
  n: "Kaelen I Rainmaker",
  e: "The God Emperor · The Black Death"
}, {
  n: "Asha Kers I",
  e: "The Bastard Goddess · The Star-Strider"
}, {
  n: "Augustus Dominus Rex",
  e: "The Final God"
}, {
  n: "Niccolò von Hapsburgi",
  e: "Thunderborn"
}, {
  n: "Germionus de Maldor",
  e: "The Quiet King · The Immune System"
}, {
  n: "Leraq of Vath",
  e: "The Va Sumir Advisor"
}, {
  n: "Isolde & Ysinde",
  e: "The Twin Empresses"
}, {
  n: "Laurentis Kers",
  e: "The Stone Giant"
}, {
  ...
  n: "Gamelon",
  e: "The Jester · The Accountant"
}, {
  n: "Kaisar Vane",
  e: "The Iron God"
}, {
  n: "Marcellus von Care",
  e: "The Mud Prince"
}, {
  n: "Dhaka",
  e: "The Rebel Commander"
}, {
  n: "Chayun",
  e: "The Dock Worker"
}];
const BESTIARY = [{
  n: "Imperial Human",
  h: 1.88,
  cls: "Homo Imperialis (Optimized Strain)",
  home: "Terra (Holy World)",
  metric: "1.88 m (6'2\")",
  notes: "Genetically optimized human at the peak of Imperial refinement. Athletic build, exceptional health, high cognitive capacity, and disciplined bearing."
}, {
  n: "Noirak",
  h: 2.75,
  cls: "Noirak Nobilis",
  ...
  notes: "Ancient and noble species. Human-presenting but subtly alien. Natural leaders with enhanced physiology and long lifespans."
}, {
  n: "Vah'Sumir",
  h: 3.6,
  cls: "Vah'Sumir Maximus",
  home: "Sumir Prime",
  metric: "3.0 – 3.6 m (9'10\" – 11'10\")",
  notes: "Massive apex warriors. Digitigrade stance, armored hide, and predatory physiology built for domination and endurance."
}, {
  n: "Ashari'i",
  h: 2.9,
  cls: "Ashari'i Immortalis",
  home: "Ashar",
  metric: "2.3 – 2.9 m (7'6\" – 9'6\")",
  notes: "Ancient immortal warrior caste. Elegant and refined features with advanced longevity and ceremonial traditions."
}, {
  n: "Gor'nath Brute",
  h: 4.2,
  cls: "Gor'nath Colossus",
  home: "Gor'nath",
  metric: "3.5 – 4.2 m (11'6\" – 13'9\")",
  notes: "Gigantic and powerfully built. Incredible strength, dense skeletal structure, and armor-like skin plates."
}, {
  n: "Yurshak Brood",
  h: 2.6,
  cls: "Yurshak Broodling",
  home: "Yurshak Hive Worlds",
  metric: "2.0 – 2.6 m (6'7\" – 8'6\")",
  notes: "Hive-evolved predators. Insectoid-reptilian morphology, multiple sensory organs, and natural weapons."
}, {
  n: "Shal'mak Aerophage",
  h: 4.0,
  cls: "Shal'mak Dominus",
  home: "High Atmosphere Layers",
  label: "Wingspan",
  metric: "6.0 – 7.5 m (19'8\" – 24'7\")",
  notes: "Aerial apex organisms. Large wings, light but strong anatomy, and adaptations for high-speed aerial hunting."
}, {
  n: "Oolak Luminary",
  h: 2.7,
  cls: "Oolak Sapientis",
  ...
  notes: "Bioluminescent beings. Their bodies produce natural light through organic structures. Ancient, wise, and highly spiritual."
}, {
  n: "Threxx War-Smith",
  h: 3.2,
  ...
  n: "Razeen Flesh-Weaver",
  h: 2.6,
  cls: "Razeen Artifex",
  home: "Razeen Vaults",
  metric: "2.1 – 2.6 m (6'11\" – 8'6\")",
  notes: "Bio-engineers and sculptors of flesh. Advanced sensory organs, elegant physiology, and masters of organic architecture."
}, {
  n: "Haal'tek Voidwalker",
  h: 3.8,
  cls: "Haal'tek Exuvia",
...
const LORE = [{
  ...
  cat: "character",
  title: "Selene Jaza",
  era: "La Generalísima Era",
  aliases: "The First Generalísima",
  appeared: "La Generalísima",
  ...
  id: 2,
  cat: "character",
  title: "Demetrius Jaza",
  era: "La Generalísima Era",
  aliases: "The Architect of Kharvat",
  appeared: "La Generalísima",
  ...
  id: 3,
  cat: "character",
  title: "Kaelen Rainmaker",
  era: "The Luceron Compact",
  aliases: "God Emperor Kaelen I, The Living Weapon, The Black Death",
  appeared: "Vol. 2, 15",
  ...
  id: 4,
  cat: "character",
  title: "Augustus Lucius Jaza",
  era: "The Merchant War",
  aliases: "The Generalísimo, Lord of Mérida",
  appeared: "Seven Victories Appendices, La Generalísima",
  ...
  cat: "character",
  title: "Asha Kers I",
  era: "The Star Wolf Era",
  aliases: "The Bastard Goddess, The Star-Strider, Queen of the Vah'Sumir",
  appeared: "Vol. 11, 17",
  ...
  id: 6,
  cat: "character",
  title: "Isolde Pierre von Care",
  era: "The Twin Thrones",
  aliases: "The Twin Empress, Dawn Empress",
  appeared: "Vol. 24",
  ...
  id: 8,
  cat: "character",
  title: "Germionus de Maldor",
  era: "The Quiet King Era",
  aliases: "The Quiet King, The Immune System",
  appeared: "Vol. 12",
  ...
  title: "Ishak",
  era: "Code of Martyrs",
  aliases: "The Withered King, The Fox",
  appeared: "Code of Martyrs Books I–IV",
  ...
  title: "Kaisar Vane",
  era: "Code of Martyrs",
  aliases: "The Iron God",
  appeared: "Code of Martyrs Book IV",
  ...
  title: "Gamelon",
  era: "Code of Martyrs",
  aliases: "The Jester, The Accountant",
  appeared: "Code of Martyrs Books I–IV",
  ...
  id: 12,
  cat: "character",
  title: "Prince Kairoh Pierre von Care",
  era: "All Eras (Compiler)",
  aliases: "Master Archivist, Grand Marshal",
  appeared: "All volumes — narrator/compiler",
  ...
  era: "All Eras",
  aliases: "The Emperor's Final Argument",
  appeared: "All volumes",
  ...
  id: 14,
  cat: "faction",
  title: "The Nine Foundry Houses of Ixoria",
  era: "All Eras",
  aliases: "The Houses, The Forge Dynasties",
  appeared: "Ixoria Canon Archive, La Generalísima Appendix VII",
  ...
  id: 15,
  cat: "faction",
  title: "The Star Wolves",
  era: "The Star Wolf Era",
  aliases: "The Eleven, The Assembly",
  appeared: "Vol. 11, 17",
  ...
  id: 16,
  cat: "faction",
  title: "The Meraud Free Republic",
  era: "La Generalísima Era",
  aliases: "The Republic, The Outer Coalition",
  appeared: "La Generalísima",
  ...
  title: "Ixoria",
  era: "All Eras",
  aliases: "The Forge-Moon, The Foundry",
  appeared: "All volumes",
  ...
  id: 18,
  cat: "location",
  title: "The Sable Absolute",
  era: "The Merchant War, La Generalísima Era",
  aliases: "The Flagship",
  appeared: "Seven Victories Appendices, La Generalísima",
  ...
  id: 19,
  cat: "location",
  title: "The Dragon Throne of Maldorus",
  era: "Code of Martyrs",
  aliases: "The Lattice Throne",
  appeared: "Code of Martyrs Books I–IV",
  ...
  era: "La Generalísima Era",
  aliases: "The Investiture, The Sealed Archive",
  appeared: "La Generalísima",
  ...
  id: 21,
  cat: "event",
  title: "The Killing of Talassar Vey",
  era: "The Merchant War",
  aliases: "The Sangfroid, The Marble Strategy Chamber",
  appeared: "Seven Victories Appendices, La Generalísima Appendix I",
  ...
  id: 22,
  cat: "event",
  title: "The Seven Fleet Launch",
  era: "The Merchant War",
  aliases: "The Gold Sky",
  appeared: "Seven Victories Appendices",
  ...
  id: 23,
  cat: "event",
  title: "The Cooling Riots",
  era: "The Luceron Industrial Era",
  aliases: "The Varekh Disaster",
  appeared: "Ixoria Canon Archive",
  ...
  id: 24,
  cat: "tradition",
  title: "The Mérida Theology",
  era: "House Jaza / La Generalísima Era",
  aliases: "",
  appeared: "La Generalísima Appendix II",
  ...
  id: 25,
  cat: "tradition",
  title: "The Death-Steel Tradition",
  era: "All Eras (Ixoria)",
  aliases: "The Mortuary Forges, The Honored Dead",
  appeared: "Ixoria Canon Archive",
  ...
  id: 26,
  cat: "technology",
  title: "The Sullied Legions",
  era: "The Clone Wars / Early Imperial",
  aliases: "The Sullied, Clone Legions, Vat-Born",
  appeared: "Vol. 1",
  ...
  id: 27,
  cat: "technology",
  title: "The Vah'Sumir Neural-Regenerative Lattice",
  era: "The Generalísima Era and After",
  aliases: "Lattice Treatment",
  appeared: "La Generalísima Appendix II",
...
const SOVEREIGNS = [{
  ...
  color: "#c9a84c",
  rulers: [{
    name: "Eustace I Bartholamer Pierre von Care",
    epithet: "The Architect",
    note: "Conceived the Trinitarian Empire in bloodline, alliance, and law. Died before its execution."
  }, {
    name: "Kerron Pierre von Care",
    epithet: "The Dragon Emperor",
    note: "Founded the Trinitarian Empire by conquest. Established ritual submission."
  }, {
    name: "Hamish Pierre von Care",
    epithet: "The Shielded King",
    note: "Preserved and consolidated the early empire."
  }, {
    name: "Cassian I",
    epithet: "The God-King",
    note: "Executed 433 rival princes. Ended competing dynasties. Made God-Emperorship a lived reality."
  }]
}, {
  era: "The Cassiel Withdrawal Era",
  color: "#7a5e28",
  rulers: [{
    name: "Cassiel I",
    epithet: "The Absent Emperor",
    note: ""
  }, {
    name: "Cassiel II",
    epithet: "The Seeker",
    ...
    name: "Cassiel III",
    epithet: "The Silent Flame",
    note: ""
  }, {
    name: "Cassiel IV (Manjooni Lucencius)",
    epithet: "The Last Withdrawn",
    note: ""
  }]
}, {
  era: "Second Cassian Restoration",
  color: "#8b3a1e",
  rulers: [{
    name: "Cassian II",
    epithet: "The Reclaimer",
    note: ""
  }, {
    name: "Cassian III",
    epithet: "The Iron Regent",
    note: ""
  }, {
    name: "Cassian IV",
    ...
    name: "Cassian V",
    epithet: "The Administrator",
    note: ""
  }, {
    name: "Cassian VI",
    epithet: "The Exhausted Lion",
    note: ""
  }]
}, {
  era: "The Quiet Eustacian Line",
  color: "#6b6070",
  rulers: [{
    name: "Eustace II",
    epithet: "The Caretaker",
    note: ""
  }, {
    name: "Eustace III",
    epithet: "The Clerk Emperor",
    note: ""
  }, {
    name: "Eustace IV",
    epithet: "The Auditor",
  ...
  era: "The Napoleonic God-Emperors",
  color: "#c9a84c",
  rulers: [{
    name: "Napoleon IV",
    epithet: "The Renamer",
    ...
    name: "Napoleon VI",
    epithet: "The Fleet-Builder",
    note: ""
  }, {
    name: "Napoleon VII",
    epithet: "The Colonizer",
    note: ""
  }, {
    name: "Napoleon VIII",
    epithet: "The Innovator",
    note: ""
  }, {
    name: "Napoleon IX",
    ...
    name: "Napoleon XVI",
    epithet: "The Enforcer",
    note: ""
  }, {
    name: "Napoleon XVII",
    epithet: "The Stabilizer",
    note: ""
  }, {
    name: "Napoleon XVIII",
    ...
    name: "— Usurpation: Naim al-Hapsburgi —",
    epithet: "Not counted",
    note: "Usurper. Not recognized in the official line."
  }, {
    name: "Napoleon XX (Lucius Pierre von Care)",
    epithet: "The Reclaimer",
    note: ""
  }, {
    name: "Napoleon XXI",
    ...
    name: "Napoleon XXVIII",
    epithet: "The Keeper",
    note: ""
  }, {
    name: "Napoleon XXIX",
    epithet: "The Accountant",
    note: ""
  }, {
    name: "Napoleon XXX",
    ...
    name: "Napoleon XXXIII",
    epithet: "The Elder",
    note: ""
  }, {
    name: "Napoleon XXXIV",
    epithet: "The Waiting King",
    note: ""
  }, {
    name: "Napoleon XXXV",
  ...
  era: "Post-Napoleonic Fracture",
  color: "#9a8fa0",
  rulers: [{
    name: "Eustace IX",
    epithet: "The Avenger's Father",
    note: "Abdicated after stabilizing the empire."
  }]
}, {
  era: "The Liberal Collapse",
  color: "#5c1515",
  rulers: [{
    name: "Erulius Bobitus",
    epithet: "The Scholar King",
    note: "Son of Eustace IX. Denounced overt godhood. Strengthened civil governance. Weakened the metaphysical authority of the Dragon Throne."
  }, {
    name: "Romulus Secundus",
    epithet: "The Pageant King",
    note: "Fiscally reckless. Indulgent. Overthrown after treasury collapse."
  }]
}, {
  era: "The Republican Experiment",
  color: "#6b6070",
  rulers: [{
    name: "Raja the Brilliant",
    epithet: "President, then King",
    note: "Abolished monarchy. Founded the Universal Republic. Public pressure forced restoration of the royal title. Died without issue."
  }]
}, {
  era: "The First Luceron Restoration",
  color: "#c9a84c",
  rulers: [{
    name: "Lucius Luceron I",
    epithet: "The Flame Bearer",
    note: "Grandson of Romulus Secundus. Republican in words. Sovereign in deeds. Clawed power back to the Dragon Throne."
  }, {
    name: "Kaelen Pierre von Care",
    epithet: "The Living Weapon",
    note: ""
  }, {
    name: "Ysinde",
    epithet: "The Dawn Empress",
    note: ""
  }, {
    name: "Isolde",
  ...
  era: "The Great Interregnum",
  color: "#5c1515",
  rulers: [{
    name: "Twenty-five years without stable sovereignty",
    epithet: "The Interregnum",
    note: "Twenty-six pretenders eliminated by Germionus de Maldor."
  }]
}, {
  era: "The Fractured Claimants",
  color: "#6b6070",
  rulers: [{
    name: "Joffrey the Generous",
    epithet: "Populist Redistributionist",
    note: "Unsustainable."
  }, {
    name: "Gabriel",
    epithet: "Administrative Reformer",
    note: "Weak support."
  }, {
    name: "Igor the Idiot",
    epithet: "Force-Based Rule",
    note: "Collapsed quickly."
  }]
}, {
  era: "The Second Luceron Restoration",
  color: "#c9a84c",
  rulers: [{
    name: "Lucius Luceron II",
    epithet: "The Restorer",
    note: "Republican façade. Gradual consolidation. Restored effective monarchy. Named his son God-Emperor at death."
  }]
}, {
  era: "The Copper and Violet Era",
  color: "#7a5e28",
  rulers: [{
    name: "Iskandar",
    epithet: "Emperor of the Copper West",
    note: "Preserved imperial structure during transition."
  }, {
    name: "Aurelia",
    epithet: "Empress of the Violet East",
    note: "Preserved imperial structure during transition."
  }, {
    name: "Lars Miraj",
    epithet: "Regent",
    ...
    name: "Lucius Luceron III",
    epithet: "The Philosopher Who Went to War",
    note: "Re-imperialized the state. Accepted full godhood at death."
  }]
}, {
  era: "Goddesses and Dominion",
  color: "#c9a84c",
  rulers: [{
    name: "Empress Amira",
    epithet: "The Bastard Goddess",
    note: ""
  }, {
    name: "Augustus Rex",
    epithet: "The Bastard God",
    note: "Led ninety billion soldiers Beyond the Rim. The Dragon Throne carries his passage in its stone."
  }, {
    name: "Livius",
    epithet: "The Maintainer",
    note: ""
  }, {
    name: "Asha Kers I",
    epithet: "La Diosa",
    note: "Codified Universal Khanate Law."
  }, {
    name: "Asha Kers II (Aurelia)",
    epithet: "The Heir Goddess",
    note: ""
  }, {
    name: "Augustus Dominus",
    epithet: "The Final God",
    note: ""
  }, {
    name: "Augustus Julius I",
    epithet: "The Successor",
    note: ""
  }, {
    name: "Augustus Julius II",
    epithet: "The Custodian",
    note: "Reigning during the Merchant War and the Generalísima investiture."
  }, {
    name: "Augustus Julius III",
    epithet: "The Last Augustan",
    note: ""
  }]
}, {
  era: "The al-Sa'ud Era",
  color: "#7a5e28",
  rulers: [{
    name: "Saldin I al-Sa'ud",
    epithet: "The Sun Prince",
    note: ""
  }, {
    name: "The al-Sa'ud Dynasty",
    epithet: "Ten Thousand Years",
    note: ""
  }, {
    name: "Sookraj",
    epithet: "The Final Saudi God-Emperor",
    note: ""
  }]
}, {
  era: "Restoration of the Bloodline",
  color: "#c9a84c",
  rulers: [{
    name: "Mettenik I Pierre von Care",
    epithet: "Restorer of the Dragon Throne",
    note: "The line returns. The empire is made whole."
  }]
}];
const TIMELINE = [{
  id: 1,
  title: "The Founding Era",
  date: "Eustace I → Cassian I",
  desc: "Eustace I Bartholamer Pierre von Care conceives the Trinitarian Empire and dies before seeing it executed. Kerron Pierre von Care founds it by conquest. Cassian I ends all rival dynasties by executing 433 princes — making God-Emperorship a lived reality rather than a claim.",
  events: [{
    y: "Foundation",
    t: "Kerron Pierre von Care — The Dragon Emperor — founds the Trinitarian Empire by conquest. Ritual submission established."
  }, {
    y: "Cassian I",
    t: "433 rival princes executed. Competing dynasties ended. The God-Emperor is no longer a title. It is a fact."
  }]
}, {
  id: 2,
  title: "The Withdrawal & Restoration Eras",
  date: "Cassiel I → Napoleon XXXV",
  desc: "Four Cassiel emperors withdraw from active rule. The Cassian line restores, then the Eustacian line administers. The Napoleonic God-Emperors — thirty-five in succession, interrupted once by the usurper Naim al-Hapsburgi — expand, colonize, integrate, and finally exhaust the empire's institutional momentum.",
  events: [{
    y: "Cassiel Era",
    t: "Four Withdrawn emperors. The throne persists without its occupant."
  }, {
    y: "Eustacian Line",
    t: "Seven Eustacian emperors — caretakers, clerks, auditors, jurists. The empire maintained by administration rather than conquest."
  }, {
    y: "Napoleonic Era",
    t: "Napoleon IV through XXXV. Thirty-five sovereigns across fleet-building, colonization, integration, and slow decline."
  }, {
    y: "Usurpation",
    t: "Naim al-Hapsburgi seizes the throne. Not counted in the official line. Napoleon XX (Lucius Pierre von Care) reclaims it."
  }]
}, {
  id: 3,
  title: "The Liberal Collapse & Republican Experiment",
  date: "Eustace IX → Raja the Brilliant",
  desc: "Erulius Bobitus denounces overt godhood and weakens the Dragon Throne's metaphysical authority. Romulus Secundus collapses the treasury. Raja the Brilliant abolishes monarchy entirely — then is forced by public pressure to restore the royal title. He dies without issue.",
  events: [{
    y: "Erulius Bobitus",
    t: "The Scholar King. Son of Eustace IX. Denounced overt godhood. Strengthened civil governance. Weakened what the throne was."
  }, {
    y: "Romulus Secundus",
    t: "The Pageant King. Fiscally reckless. Overthrown after treasury collapse."
  }, {
    y: "Raja the Brilliant",
    t: "Abolished monarchy. Founded the Universal Republic. Forced to restore the royal title. Died without issue."
  }]
}, {
  id: 4,
  title: "The First Luceron Restoration",
  date: "Lucius Luceron I → Cassander II",
  desc: "Lucius Luceron I — grandson of Romulus Secundus, The Flame Bearer — is republican in words and sovereign in deeds. He claws power back to the Dragon Throne. The line runs through Kaelen, the Twin Thrones, Aurelian the Murdered Sun, and the two Cassanders.",
  events: [{
    y: "Lucius Luceron I",
    t: "The Flame Bearer. Republican in words. Sovereign in deeds. Power returns to the Dragon Throne."
  }, {
    y: "Kaelen Pierre von Care",
    t: "The Living Weapon. Black armor. Green eyes. The God Emperor."
  }, {
    y: "Ysinde & Isolde",
    t: "The Twin Thrones — The Dawn Empress and The Twin Throne. The Four Who Sat the East."
  }, {
    y: "Aurelian",
    t: "The Murdered Sun. Aurelian made them love him."
  }, {
    y: "Cassander I & II",
    t: "The Avenger and The Stabilizer. Cassander made them obey."
  }]
}, {
  id: 5,
  title: "The Great Interregnum & Fractured Claimants",
  date: "25 Years Without Sovereignty",
  desc: "Twenty-five years without stable sovereignty. Twenty-six pretenders eliminated by Germionus de Maldor — The Quiet King, The Immune System. Three named claimants leave only wreckage before the Second Luceron Restoration.",
  events: [{
    y: "The Interregnum",
    t: "Twenty-six pretenders. Germionus de Maldor eliminates each one. The throne waits."
  }, {
    y: "Joffrey, Gabriel, Igor",
    t: "Populist redistribution, administrative reform, force. Each collapses. None holds."
  }]
}, {
  id: 6,
  title: "The Second Luceron Restoration & Copper-Violet Era",
  date: "Lucius Luceron II → Lucius Luceron III",
  desc: "Lucius Luceron II — The Restorer — maintains a republican façade while gradually consolidating monarchy. He names his son God-Emperor at death. The Copper and Violet Era follows — Iskandar, Aurelia, and Regent Lars Miraj preserve structure through transition. Lucius Luceron III re-imperializes the state and accepts full godhood at death.",
  events: [{
    y: "Lucius Luceron II",
    t: "Republican façade. Gradual consolidation. Named his son God-Emperor at death."
  }, {
    y: "The Copper and Violet Era",
    t: "Iskandar (Copper West), Aurelia (Violet East), Lars Miraj (Regent) — the triumvirate that holds the empire through transition."
  }, {
    y: "Lucius Luceron III",
    t: "The Philosopher Who Went to War. Re-imperialized the state. Accepted full godhood at death."
  }]
}, {
  id: 7,
  title: "Goddesses and Dominion",
  date: "Empress Amira → Augustus Julius III",
  desc: "The age of Bastard Gods and Goddesses. Empress Amira. Augustus Rex — who went Beyond the Rim and returned having replaced a god. Livius the Maintainer. Asha Kers I, who codified Universal Khanate Law. The Augustan line ends with Julius III.",
  events: [{
    y: "Empress Amira",
    t: "The Bastard Goddess — The First Goddess-Empress."
  }, {
    y: "Augustus Rex",
    t: "The Bastard God. Led ninety billion soldiers Beyond the Rim. The Dragon Throne carries his passage in its stone."
  }, {
    y: "Asha Kers I",
    t: "La Diosa. Codified Universal Khanate Law. Ruled forty-one years. Walked to the platform with 17,426 names under her arm."
  }, {
    y: "The Augustan Line",
    t: "Augustus Dominus (The Final God), Augustus Julius I, II (The Custodian — reigning during the Merchant War), III (The Last Augustan)."
  }]
}, {
  id: 8,
  title: "The al-Sa'ud Era & Restoration of the Bloodline",
  date: "Saldin I → Mettenik I",
  desc: "The al-Sa'ud dynasty — Saldin I through Sookraj, the Final Saudi God-Emperor — holds the throne for what the records call Ten Thousand Years. The compact Demetrius Jaza built with Leila al-Sa'ud four centuries prior finally matures. Mettenik I Pierre von Care restores the bloodline.",
  events: [{
    y: "Saldin I al-Sa'ud",
    t: "The Sun Prince. The Saudi era begins."
  }, {
    y: "The al-Sa'ud Dynasty",
    t: "Ten Thousand Years. The longest unbroken tenure in the history of the Dragon Throne."
  }, {
    y: "Sookraj",
    t: "The Final Saudi God-Emperor."
  }, {
    y: "Mettenik I Pierre von Care",
    t: "Restorer of the Dragon Throne. The Pierre von Care bloodline returns. The empire is made whole."
  }]
}];
...
function Nav({
  ...
  return React.createElement("nav", {
    ...
    className: "nav-brand",
    onClick: () => go("home")
  }, "The Iseldoran Sagas"), React.createElement("ul", {
    className: "nav-links"
...
function HomePage({
  ...
  }, "The Official Archive of"), React.createElement("h1", {
    className: "hero-title"
  }, "The Iseldoran Sagas"), React.createElement("div", {
    className: "hero-subtitle"
  }, "Dragon Throne \xB7 Black Death \xB7 The Forge-Moon \xB7 The Star Wolves \xB7 La General\xEDsima \xB7 Code of Martyrs"), React.createElement("div", {
    className: "hero-rule"
  }, React.createElement("div", {
    className: "hero-gem"
  })), React.createElement("p", {
    className: "hero-lore"
  }, "Thirty-eight volumes across two universes. 1,747,478+ words. Eight eras of empire. From Augustus Rex Beyond the Rim to the Compact of Kharvat four centuries hence. The official compendium \u2014 every emperor, every commander, every war, every world."), React.createElement("div", {
    className: "hero-cta"
  }, React.createElement("button", {
    className: "btn-primary",
    onClick: () => go("novels")
  }, "Browse All Volumes"), React.createElement("button", {
    className: "btn-secondary",
    onClick: () => go("compendium")
  }, "Enter the Compendium")))), React.createElement("div", {
    className: "stats-bar"
  }, [{
    n: "38",
    l: "Volumes"
...
function NovelsPage() {
  ...
  return React.createElement("div", {
  ...
  }, "The Complete Library \xB7 1,747,478+ Words"), React.createElement("h2", {
    className: "section-title"
  }, "All Volumes"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "Compiled by Prince Kairoh Pierre von Care, Master Archivist of the Imperial Archive, Bundchen Prime.")), React.createElement("div", {
  ...
  }), ["all", "iseldoran", "generalisima", "martyrs"].map(s => React.createElement("button", {
    key: s,
    className: `filter-btn ${seriesFilter === s ? "active" : ""}`,
    onClick: () => setSeriesFilter(s)
  }, s === "all" ? "All Series" : s === "iseldoran" ? "Iseldoran Sagas" : s === "generalisima" ? "La Generalísima" : "Code of Martyrs"))), React.createElement("div", {
    ...
    className: "book-num"
  }, "#", b.id), React.createElement("span", {
    className: `book-series-tag ${b.series === "martyrs" ? "martyrs" : "iseldoran"}`
  }, b.series === "martyrs" ? "Code of Martyrs" : b.series === "generalisima" ? "Generalísima" : "Iseldoran"), b.cover ? React.createElement("img", {
    src: b.cover,
    alt: b.title
  }) : React.createElement("div", {
    ...
    className: "book-subtitle-sm"
  }, b.sub), React.createElement("div", {
    className: "book-words"
  }, b.words, " words"), React.createElement("div", {
...
function CharactersPage() {
  ...
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "Imperial Portrait Archive \xB7 Bundchen Prime"), React.createElement("h2", {
    className: "section-title"
  }, "Character Portraits"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "The God Emperors, commanders, advisors, and figures of the Iseldoran Sagas and Code of Martyrs.")), React.createElement("div", {
    className: "books-filter",
    style: {
      marginBottom: "2.5rem"
    }
  }, React.createElement("button", {
    className: `filter-btn ${gallery === "20" ? "active" : ""}`,
    onClick: () => setGallery("20")
  }, "20 God Emperors"), React.createElement("button", {
    className: `filter-btn ${gallery === "14" ? "active" : ""}`,
    onClick: () => setGallery("14")
  }, "14 Major Characters"), React.createElement("button", {
    className: `filter-btn ${gallery === "leraq" ? "active" : ""}`,
    onClick: () => setGallery("leraq")
  }, "Leraq of Vath")), gallery === "20" && React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      marginBottom: "1.5rem"
    }
  ...
  }, PORTRAITS_20.map((p, i) => React.createElement("div", {
    className: "portrait-card",
    key: i
  }, React.createElement("div", {
    className: "portrait-img-ph"
  }, "\u25C8"), React.createElement("div", {
    className: "portrait-name"
  }, i + 1, ". ", p.n), React.createElement("div", {
    className: "portrait-epithet"
  }, p.e))))), gallery === "14" && React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      marginBottom: "1.5rem",
      display: "grid",
    ...
    src: IMG.characters14wide,
    alt: "14 Characters Wide",
    style: {
      width: "100%",
      border: "1px solid rgba(201,168,76,0.2)",
      display: "block"
    ...
    className: "portraits-grid"
  }, PORTRAITS_14.map((p, i) => React.createElement("div", {
    className: "portrait-card",
    key: i
  }, React.createElement("div", {
    className: "portrait-img-ph"
    ...
    className: "portrait-epithet"
  }, p.e))))), gallery === "leraq" && React.createElement("div", {
    style: {
      display: "flex",
      gap: "2rem",
  ...
  }, "Leraq of Vath"), React.createElement("div", {
    style: {
  ...
  }, "The Va Sumir Advisor"), React.createElement("p", {
    style: {
  ...
  }, "An elder of an ancient non-human order \u2014 the Va Sumir. His autobiography (Volume 19, 5,157 words) constitutes one of the primary sources of the Imperial Archive. He served as advisor across multiple eras of the empire."), React.createElement("p", {
    style: {
      fontFamily: "var(--font-body)",
      color: "var(--bone)",
      lineHeight: 1.85
    }
  }, "His portrait shows: a pale, deeply lined face; pointed ears; gold lattice crown; grey-blue deep-set eyes. A dark uniform with gold pauldrons, crimson inner cloak, blue stone at the chest. The particular stillness of someone who has watched multiple civilizations rise and decline.")))));
}
function LoreModal({
  entry,
  onClose
  ...
  return React.createElement("div", {
    ...
    className: "modal-tag"
  }, LORE_CATS.find(c => c.id === entry.cat)?.label, " \xB7 ", entry.era), React.createElement("h2", {
    className: "modal-title"
  }, entry.title), React.createElement("button", {
    className: "modal-close",
    onClick: onClose
  }, "\u2715")), React.createElement("div", {
    className: "modal-body"
  }, entry.full.split("\n\n").map((p, i) => React.createElement("p", {
    key: i
  }, p)), entry.quote && React.createElement("div", {
    className: "modal-quote"
  }, "\"", entry.quote, "\""), React.createElement("div", {
    className: "modal-meta"
  }, entry.aliases && React.createElement("div", null, React.createElement("label", null, "Also Known As"), React.createElement("span", null, entry.aliases)), React.createElement("div", null, React.createElement("label", null, "Era"), React.createElement("span", null, entry.era)), React.createElement("div", null, React.createElement("label", null, "Classification"), React.createElement("span", null, LORE_CATS.find(c => c.id === entry.cat)?.label)), entry.appeared && React.createElement("div", null, React.createElement("label", null, "Appears In"), React.createElement("span", null, entry.appeared))))));
}
function CompendiumPage() {
  ...
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "Imperial Archive \xB7 Bundchen Prime"), React.createElement("h2", {
    className: "section-title"
  }, "The Lore Compendium"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "Characters, factions, locations, events, traditions, and technology across all eras and series. Drawn from primary manuscripts and the sealed archive.")), React.createElement("div", {
    className: "lore-layout"
  }, React.createElement("div", {
    className: "lore-sidebar"
  }, React.createElement("div", {
    className: "lore-sidebar-header"
  }, "Archive Categories"), LORE_CATS.map(c => React.createElement("button", {
    key: c.id,
    className: `lore-cat-btn ${cat === c.id ? "active" : ""}`,
    onClick: () => setCat(c.id)
  }, React.createElement("span", null, c.icon), React.createElement("span", null, c.label), React.createElement("span", {
    className: "lore-cat-count"
  }, counts[c.id])))), React.createElement("div", null, React.createElement("input", {
    className: "lore-search-input",
    placeholder: "Search the archive\u2026",
    value: search,
    onChange: e => setSearch(e.target.value)
  }), React.createElement("div", {
    className: "lore-entries"
  }, filtered.map(e => React.createElement("div", {
    className: "lore-entry",
    key: e.id,
    onClick: () => setSelected(e)
  }, React.createElement("div", {
    className: "lore-entry-tag"
  }, LORE_CATS.find(c => c.id === e.cat)?.icon, " ", LORE_CATS.find(c => c.id === e.cat)?.label, " \xB7 ", e.era), React.createElement("div", {
    className: "lore-entry-title"
  }, e.title), React.createElement("div", {
    className: "lore-entry-excerpt"
  }, e.excerpt))), filtered.length === 0 && React.createElement("div", {
    style: {
      gridColumn: "1/-1",
      textAlign: "center",
      padding: "4rem",
  ...
  }, "No entries match your search."))))), selected && React.createElement(LoreModal, {
    entry: selected,
...
function TimelinePage() {
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "Eight Eras \xB7 Augustus Rex to the Compact of Kharvat"), React.createElement("h2", {
    className: "section-title"
  }, "The Imperial Timeline"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "The shape of an empire across time \u2014 compiled from primary records at Bundchen Prime.")), React.createElement("div", {
    className: "timeline"
  }, TIMELINE.map(era => React.createElement("div", {
    className: "timeline-era",
    key: era.id
  }, React.createElement("div", {
    className: "timeline-dot"
  }), React.createElement("div", {
    className: "timeline-era-date"
  }, era.date), React.createElement("div", {
    className: "timeline-era-title"
  }, era.title), React.createElement("div", {
    className: "timeline-era-desc"
  }, era.desc), React.createElement("div", {
    className: "timeline-events"
  }, era.events.map((ev, i) => React.createElement("div", {
    className: "timeline-event",
    key: i
  }, React.createElement("div", {
    className: "timeline-event-year"
  }, ev.y), React.createElement("div", {
...
function IxoriaPage() {
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "The Forge-Moon \xB7 The Kasparian Belt"), React.createElement("h2", {
    className: "section-title"
  }, "Ixoria"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
  ...
  }, "Steel remembers the hand that shaped it. The hand does not wait to see where the steel goes.")), React.createElement("div", {
    style: {
      fontFamily: "var(--font-body)",
      color: "var(--bone)",
      lineHeight: 1.85,
  ...
  }, "The empire tolerated their power because no alternative existed. Ixoria did not merely produce ships. Ixoria maintained civilization-scale military continuity.")), React.createElement("div", {
    style: {
      fontFamily: "var(--font-title)",
      fontSize: "0.58rem",
  ...
  }, "The Nine Houses of the Forge"), React.createElement("div", {
    className: "nine-houses-grid"
  }, NINE_HOUSES.map(h => React.createElement("div", {
    className: "house-card",
    key: h.name
  }, React.createElement("div", {
    className: "house-name"
  }, h.name), React.createElement("div", {
    className: "house-specialty"
  }, h.specialty), React.createElement("div", {
    className: "house-motto"
  }, h.motto), React.createElement("div", {
    className: "house-desc"
  }, h.desc)))), React.createElement("div", {
    style: {
      marginTop: "3rem",
      padding: "1.75rem",
  ...
  }, "Hard Canon \xB7 The Cooling Riots"), React.createElement("p", {
    style: {
      fontFamily: "var(--font-body)",
      color: "var(--bone)",
      lineHeight: 1.8,
  ...
  }, "House Varekh redirected coolant resources toward military production during a frontier emergency. Habitation temperatures in the Lower Furnace Districts exceeded survivable thresholds. Estimated dead: 2.4 million. Eleven days. Director Havel Tor Varekh was responsible. His name remains a curse in lower habitation sectors. Workers still spit after saying it aloud."))));
}
function CoversPage() {
  const covers = [{
    src: IMG.generalisima3,
    cap: "La Generalísima — Cover Art III"
  }, {
    src: IMG.generalisima1,
    cap: "La Generalísima — Cover Art I"
  }, {
    src: IMG.generalisima2,
    cap: "La Generalísima: Appendices & Notes"
  }, {
    src: IMG.fiveSwords1,
    cap: "Five Swords, One Throne"
  }, {
    src: IMG.fiveSwords2,
    cap: "Five Swords, One Throne — Full Wrap"
  }, {
    src: IMG.emperors20,
    cap: "20 God Emperors Portrait Gallery"
  }, {
    src: IMG.characters14,
    cap: "14 Major Characters"
  }, {
    src: IMG.characters14wide,
    cap: "14 Characters — Wide Format"
  }, {
    src: IMG.leraq,
    cap: "Leraq of Vath"
  }];
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "Official Cover Art & Character Portraits"), React.createElement("h2", {
    className: "section-title"
  }, "The Art Archive"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "Cover art, full wraps, and character portrait galleries from across the Iseldoran Sagas and Code of Martyrs.")), React.createElement("div", {
    className: "cover-gallery"
  }, covers.map((c, i) => React.createElement("div", {
...
function AboutPage() {
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "The Archive \xB7 Bundchen Prime"), React.createElement("h2", {
    className: "section-title"
  }, "About the Sagas"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8"))), React.createElement("div", {
  ...
  }, "The Iseldoran Sagas is a thirty-volume, 1,747,478-word science fantasy universe spanning eight imperial eras \u2014 from the age of Augustus Rex Beyond the Rim to the Compact of Kharvat, four centuries hence. The universe also includes La General\xEDsima, the sealed archive of Selene Jaza, and the Code of Martyrs saga \u2014 four volumes set in the Dragon Throne of Maldorus universe."), React.createElement("p", {
    style: {
      marginBottom: "1.5rem"
    }
  }, "All volumes are compiled by Prince Kairoh Pierre von Care, Master Archivist of the Imperial Archive at Bundchen Prime \u2014 himself a figure within the history he records. He gave Augustus Lucius Jaza his first order. He commissioned the legal opinion that ended Asha Kers I's reign. He held Aurelia's Wrath for twenty years. He sealed the archive in Year Twenty-Five of the General\xEDsima. The archive is addressed to his son Livian."), React.createElement("div", {
    style: {
      fontFamily: "var(--font-lore)",
      fontStyle: "italic",
      color: "var(--mist)",
  ...
  }, "\"The Emperor builds the empire. The General\xEDsima defends its existence. The Archivist ensures its memory.\"", React.createElement("span", {
    style: {
      fontFamily: "var(--font-title)",
      fontSize: "0.65rem",
  ...
  }, "\u2014 Kairoh Pierre von Care")), React.createElement("div", {
    style: {
      fontFamily: "var(--font-lore)",
      fontStyle: "italic",
      color: "var(--mist)",
  ...
  }, "\"Loyalty is reality. Reality is law. Law is eternal.\"", React.createElement("span", {
    style: {
      fontFamily: "var(--font-title)",
      fontSize: "0.65rem",
      letterSpacing: "0.15em",
  ...
  }, "\u2014 La General\xEDsima motto")), React.createElement("div", {
    style: {
      display: "flex",
      gap: "1rem",
      flexWrap: "wrap"
    ...
    className: "btn-primary",
    onClick: () => alert("Add your author page / contact link here")
  }, "Author Contact"), React.createElement("button", {
    className: "btn-secondary",
    onClick: () => alert("Add your newsletter or social link here")
  }, "Newsletter")))));
}
function Footer({
  go
  ...
  }, "\xA9 ", new Date().getFullYear(), " Prince Kairoh Pierre von Care \xB7 The Iseldoran Press \xB7 All rights reserved \xB7 Bundchen Prime"));
}
function SovereignsPage() {
  ...
  const filtered = SOVEREIGNS.filter(e => activeEra === "all" || e.era === activeEra).map(eraGroup => ({
    ...eraGroup,
    rulers: eraGroup.rulers.filter(r => r.name.toLowerCase().includes(search.toLowerCase()) || r.epithet.toLowerCase().includes(search.toLowerCase()) || r.note.toLowerCase().includes(search.toLowerCase()))
  ...
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "The Authoritative Chronological Record"), React.createElement("h2", {
    className: "section-title"
  }, "Dragon Throne Sovereigns"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "From Eustace I to Mettenik I \u2014 the complete line of God-Emperors of the Trinitarian Empire.")), React.createElement("div", {
    style: {
      display: "flex",
      gap: "1rem",
      marginBottom: "2rem",
  ...
  }, totalSovereigns, " sovereigns across ", SOVEREIGNS.length, " eras")), React.createElement("div", {
    style: {
      display: "flex",
      gap: "0.4rem",
      flexWrap: "wrap",
    ...
    className: `filter-btn ${activeEra === "all" ? "active" : ""}`,
    onClick: () => setActiveEra("all")
  }, "All Eras"), SOVEREIGNS.map(e => React.createElement("button", {
    key: e.era,
    className: `filter-btn ${activeEra === e.era ? "active" : ""}`,
    onClick: () => setActiveEra(e.era),
    style: {
      fontSize: "0.5rem"
    }
  }, e.era))), React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "2.5rem"
    }
  }, filtered.map((eraGroup, gi) => eraGroup.rulers.length > 0 && React.createElement("div", {
    key: gi
  }, React.createElement("div", {
    style: {
      display: "flex",
      ...
      borderBottom: `1px solid ${eraGroup.color}44`
    }
  }, React.createElement("div", {
    style: {
      width: "3px",
      height: "1.4rem",
      background: eraGroup.color,
      flexShrink: 0
    }
  }), React.createElement("div", {
    style: {
      fontFamily: "var(--font-display)",
      fontSize: "0.85rem",
      color: eraGroup.color
    }
  }, eraGroup.era), React.createElement("div", {
    style: {
      fontFamily: "var(--font-title)",
      fontSize: "0.5rem",
  ...
  }, eraGroup.rulers.filter(r => !r.epithet.includes("Not counted") && !r.epithet.includes("Interregnum")).length, " sovereign", eraGroup.rulers.filter(r => !r.epithet.includes("Not counted") && !r.epithet.includes("Interregnum")).length !== 1 ? "s" : "")), React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))",
      gap: "0.75rem"
    }
  }, eraGroup.rulers.map((r, ri) => React.createElement("div", {
    key: ri,
    style: {
    ...
    style: {
      ...
      fontSize: "0.75rem",
      color: eraGroup.color,
      marginBottom: r.note ? "0.45rem" : 0
    }
  }, r.epithet), r.note && React.createElement("div", {
    style: {
      fontFamily: "var(--font-body)",
      fontSize: "0.8rem",
      color: "var(--smoke)",
...
function BestiaryPage() {
  ...
  return React.createElement("div", {
    ...
    className: "section-eyebrow"
  }, "Imperial Academy \xB7 Xenobiological Archives"), React.createElement("h2", {
    className: "section-title"
  }, "The Great Bestiary of the Rim"), React.createElement("div", {
    className: "section-rule"
  }, React.createElement("span", {
    className: "section-rule-icon"
  }, "\u25C8")), React.createElement("p", {
    className: "section-desc"
  }, "Catalogued specimens of the sentient and engineered species of the Iseldoran Rim. Select a specimen to review its archival plate, record, and comparative scale.")), React.createElement("div", {
    className: "codex-featured"
  }, React.createElement("div", {
    className: "codex-plate",
    onClick: () => setZoom(true)
  }, React.createElement("img", {
    src: plateSrc(sel),
    alt: `${b.n} specimen plate`
  }), React.createElement("span", {
    className: "codex-zoom"
  }, "\u2922 Enlarge")), React.createElement("div", {
    className: "codex-dossier"
  }, React.createElement("div", {
    className: "codex-desig"
  }, "Specimen No. ", String(sel + 1).padStart(2, "0"), " \xB7 Iseldoran Rim"), React.createElement("h3", {
    className: "codex-name"
  }, b.n), React.createElement("div", {
    className: "codex-class"
  }, b.cls), React.createElement("div", {
    className: "codex-stats"
  }, React.createElement("div", {
    className: "codex-stat"
  }, React.createElement("span", {
    className: "k"
  }, "Homeworld"), React.createElement("span", {
    className: "v"
  }, b.home)), React.createElement("div", {
    className: "codex-stat"
  }, React.createElement("span", {
    className: "k"
  }, b.label || "Average Height"), React.createElement("span", {
    className: "v"
  }, b.metric)), React.createElement("div", {
    className: "codex-stat"
  }, React.createElement("span", {
    className: "k"
  }, "Relative Scale"), React.createElement("span", {
    className: "v"
  }, (b.h / human).toFixed(1), "\xD7 human"))), React.createElement("p", {
    className: "codex-notes"
  }, b.notes), React.createElement("div", {
    className: "codex-nav"
  }, React.createElement("button", {
    className: "codex-navbtn",
    onClick: () => go(-1)
  }, "\u2039 Prev"), React.createElement("button", {
    className: "codex-navbtn",
    onClick: () => go(1)
  }, "Next \u203A"), React.createElement("span", {
    className: "codex-counter"
  }, sel + 1, " / ", BESTIARY.length)))), React.createElement("div", {
    className: "codex-roster"
  }, BESTIARY.map((s, i) => React.createElement("div", {
    key: i,
    className: `roster-item ${i === sel ? "active" : ""}`,
    onClick: () => setSel(i),
    title: s.n
  }, React.createElement("img", {
    src: plateSrc(i),
    ...
    className: "codex-scale"
  }, React.createElement("div", {
    className: "scale-title"
  }, "Comparative Scale"), React.createElement("div", {
    className: "scale-sub"
  }, "Average standing height across the catalogued species, drawn to scale. Tap a column to inspect that specimen."), React.createElement("div", {
    className: "scale-chart"
  }, BESTIARY.map((s, i) => React.createElement("button", {
    key: i,
    className: `scale-bar ${i === sel ? "active" : ""}`,
    onClick: () => setSel(i),
    title: `${s.n} — ${s.h} m`
  }, React.createElement("span", {
    ...
    className: "bh"
  }, s.h.toFixed(1), "m"), React.createElement("span", {
    className: "bar",
    style: {
      height: `${Math.round(s.h / maxH * 100)}%`
    }
  })), React.createElement("span", {
    className: "bl"
  }, s.n)))))), zoom && React.createElement("div", {
    className: "codex-lightbox",
    onClick: () => setZoom(false)
  }, React.createElement("img", {
    src: plateSrc(sel),
    alt: `${b.n} specimen plate, enlarged`
  })));
}
function App() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(StyleInjector, null), React.createElement(Nav, {
    page: page,
    go: go
  }), page === "home" && React.createElement(HomePage, {
    go: go
  }), page === "novels" && React.createElement(NovelsPage, null), page === "characters" && React.createElement(CharactersPage, null), page === "bestiary" && React.createElement(BestiaryPage, null), page === "compendium" && React.createElement(CompendiumPage, null), page === "sovereigns" && React.createElement(SovereignsPage, null), page === "timeline" && React.createElement(TimelinePage, null), page === "ixoria" && React.createElement(IxoriaPage, null), page === "covers" && React.createElement(CoversPage, null), page === "about" && React.createElement(AboutPage, null), React.createElement(Footer, {
    go: go
  }));
}
