# The Iseldoran Sagas — X / Twitter Post Queue

Canon-accurate, ready-to-post lore drops. Sourced from the wiki (`IseldoranSagasWiki.jsx`,
`species.mjs`, `README.md`). Each entry is designed to stand alone. Most fit the 280-char
limit; a couple are flagged as short threads.
